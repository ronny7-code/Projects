...
public class LibraryManagementSystem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        manageBooksButton.setFocusable(false);
        ...
        manageIssueButton.setFocusable(false);
        ...
        loginPanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 240, -1));
        ...
        loginPanel.add(loginButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 210, 100, 40));
    ...
    private void manageIssueButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageIssueButtonActionPerformed
        // TODO add your handling code here:
        contentPanel.removeAll();
        contentPanel.add(new IssueBookPanel());
        contentPanel.revalidate();
        contentPanel.repaint();
